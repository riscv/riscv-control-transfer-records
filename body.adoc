...
_Placeholder: when reducing depth, first execute the clear instruction._
====
...
[WARNING]
====
_Placeholder: CtrCycleCounter and CCV are cleared on execution of the clear instruction._
====
