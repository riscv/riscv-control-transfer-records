...
|MTE |If ETEN=1, enables recording of traps to M-mode when M=0.  See <<External Traps>>.

|STE |If ETEN=1, enables recording of traps to S-mode when S=0.  See <<External Traps>>.
...
recorded. If ETEN=STE=1, external traps to S-mode will be recorded.  See <<External Traps>>.
