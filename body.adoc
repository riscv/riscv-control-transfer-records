...
|BRINH |Inhibit recording of taken branch instructions.  See <<_transfer_type_filtering, Transfer Type Filtering>>. |WARL 
...
The number of TOS bits supported is implementation-dependent, but must sufficient to index the array at the maximum depth supported (e.g., 4 bits for a max depth of 16).|WARL 
...
Bit 55 is the position of CTR in mstateen0 and hstateen0.
