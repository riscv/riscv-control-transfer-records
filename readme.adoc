= RISC-V Control Transfer Records (CTR)

The CTR TG was established to develop an ISA extension to record recent control transfers.  See the group charter https://github.com/riscv-admin/control-transfer-records/blob/main/CHARTER.md[[.underline]#here#].
